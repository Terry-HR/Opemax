    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="card shadow rounded">
                <div class="card-body">
                    <h4 class="card-title text-center text-primary mb-4">Encuesta de Internet Movil</h4>

                    <form action="GuardarEmovilServlet" method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">¿Cuál es la operadora a la que perteneces?</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">¿Qué plan tienes contratado en GBs?</label>
                            <input type="number" step="0.01" min="0" name="plan" placeholder="0.00" class="form-control" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">¿Cuántos MBs recibes en tu teléfono celular?</label>
